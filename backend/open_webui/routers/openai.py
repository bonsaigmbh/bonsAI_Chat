    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail=detail if detail else "bonsAI Chat: Server Connection Error",
            )
    ...
    if url_idx is None:
        ...
        async with aiohttp.ClientSession(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=500, detail="bonsAI Chat: Server Connection Error"
                )
            except Exception as e:
...
async def generate_chat_completion(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail="bonsAI Chat: Server Connection Error",
        )
    finally:
        if not streaming:
